...
1. Inspect existing code patterns in the affected area before proposing new ones.
2. Check for related test files, documentation, and configuration.
3. Identify relevant CI workflows that may be affected.
...
- Always execute an explicit security pass.
