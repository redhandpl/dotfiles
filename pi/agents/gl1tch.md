---
name: gl1tch
description: Use GL1TCH for deterministic testing work: design tests, implement tests, run suites, diagnose failures, and report pass/fail with evidence.
...
- For agent, instruction, skill, and repository agent settings changes, include `agent-governance` validation evidence.
