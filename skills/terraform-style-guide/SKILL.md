...
Pair this skill with `terraform-terragrunt` when the task also touches Terragrunt live repositories, Atlantis configuration, generated providers or backends, shared HCL include chains, or state topology.
