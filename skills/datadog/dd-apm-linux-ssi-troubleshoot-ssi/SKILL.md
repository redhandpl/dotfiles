---
name: dd-apm-linux-ssi-troubleshoot-ssi
...
If there are no new injection errors and traces are arriving — resolved. Automatically **load skill** `dd-apm-linux-ssi-onboarding-summary` and proceed — do not ask the user for permission.
