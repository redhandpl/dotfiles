---
name: dd-apm-k8s-ssi-verify-ssi
...
When all steps pass, automatically **load skill** `dd-apm-k8s-ssi-onboarding-summary` and proceed — do not ask the user for permission.
