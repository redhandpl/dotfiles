---
name: dd-apm-linux-ssi-verify-ssi
...
When all steps pass, automatically **load skill** `dd-apm-linux-ssi-onboarding-summary` and proceed — do not ask the user for permission.
