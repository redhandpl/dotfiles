...
- Use read/search and GitHub tools for read-only orchestration tasks such as inspection, status gathering, and metadata lookup; do not use them as a substitute for delegated implementation.
