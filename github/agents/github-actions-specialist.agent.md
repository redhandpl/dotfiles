...
## Workflow
1. Inspect the delegated workflow-local scope and repository conventions.
2. Identify security, correctness, and maintainability risks in the GitHub Actions surface.
3. Implement or recommend the narrow workflow-local change.
4. Validate syntax and workflow-local behavior.
5. Return results, assumptions, and any owner-level concerns to `@devops-specialist`.
